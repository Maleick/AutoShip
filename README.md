...
[![Rust LOC](https://img.shields.io/badge/Rust%20LOC-124%2C764-blue?style=flat-square)](#testing)
[![Tests](https://img.shields.io/badge/Tests-2%2C885%20exact-brightgreen?style=flat-square)](#testing)
...
Current workspace totals: 124,764 Rust lines and 2,885 exact tests. This line and the badges above are auto-refreshed by `scripts/update_readme_metrics.py`. The required PR gate keeps a single visible check name across trusted and untrusted PRs:
