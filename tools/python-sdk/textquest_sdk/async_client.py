...
class AsyncTextQuestClient:
    ...
    async def get_alert_config(self) -> Dict[str, Any]:
        ...
        Returns:
            Alert configuration
        """
        return await self._make_request("GET", "/api/alerts/config")
    ...
    async def set_alert_config(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Returns:
            Updated configuration
        """
        return await self._make_request("PUT", "/api/alerts/config", json_data=config)
    ...
    async def add_spawn_watch_pattern(self, pattern: str) -> Dict[str, Any]:
        ...
        Returns:
            Updated watch list
        """
        return await self._make_request("PUT", f"/api/spawn-alerts/watch-list/{pattern}")
    ...
    async def remove_spawn_watch_pattern(self, pattern: str) -> None:
        ...
        """
        client = await self._ensure_client()
        response = await client.delete(f"/api/spawn-alerts/watch-list/{pattern}")
        response.raise_for_status()

    # ─── GM Alerts ───────────────────────────────────────────────────────

    async def list_gm_alerts(self) -> List[Dict[str, Any]]:
        """List GM detection alerts.

        Returns:
            List of GM alerts
        """
        return await self._make_request("GET", "/api/gm-alerts")
    ...
    async def get_gm_alert_state(self) -> Dict[str, Any]:
        ...
        Returns:
            GM alert state
        """
        return await self._make_request("GET", "/api/gm-alerts/state")
    ...
    async def list_kill_tracker_records(self) -> List[Dict[str, Any]]:
        ...
        """
        return await self._make_request("GET", "/api/kill-tracker/records")
    ...
    async def get_kill_tracker_stats(self) -> Dict[str, Any]:
        ...
        Returns:
            Kill tracker stats
        """
        return await self._make_request("GET", "/api/kill-tracker/stats")
