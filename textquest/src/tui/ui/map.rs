...
mod tests {
    ...
    fn test_player_marker_not_rendered_when_no_spawns() {
        ...
        assert!(
            !rendered.is_empty(),
            "Map should render even with no player"
        );
    }
    ...
    fn test_player_marker_updates_with_spawn_position() {
        ...
        assert_ne!(
            original, moved,
            "Map should update when player position changes"
        );
    }
...
"#;
    ...
    fn test_zone_exit_rendered_as_diamond_glyph() {
        ...
        assert!(
            rendered.contains('◇'),
            "Zone exit diamond glyph not found in rendered map"
        );
    }
    ...
    fn test_viewbounds_from_zone_map() {
        ...
        use crate::eq::map_parser::MapBounds;
