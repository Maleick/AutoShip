...
seven screens already present in the app (Characters, Tactical, Navigation,
Debug, Packets, Economy, Orchestrator) plus the existing overlay surfaces
...
```
 6x EQ │ 1/6 Venkhadrei │ G2 Fear Core │ Bertoxxulous │ Plane of Fear      [1 Char][2 Map][3 Nav][4 Dbg][5 Pkt][6 Eco][7 Orc]
```
...
### 7. Orchestrator — `ui/orchestrator.rs`
