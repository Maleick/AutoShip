...
pub mod profile {
    ...
    /// Total spell-book slots in `BaseProfile::SpellBook` (alias for `SPELL_BOOK_SLOT_COUNT`).
    ...
    /// Alias for `MEMORIZED_SPELL_GEM_COUNT` — number of visible memorized spell gems.
