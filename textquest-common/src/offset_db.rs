...
impl OffsetDatabase {
    ...
    pub fn from_compiled_offsets() -> Self {
        use crate::offsets::{
            ...
            FREE_TARGET_CAST_SPELL, GET_BEARING, GET_CON_LEVEL, GET_PC_CLIENT,
            INBOUND_MSG_COUNTER, INTERPRET_CMD, INV_SLOT_GET_ITEM_BASE, INV_SLOT_MGR_FIND_SLOT,
            INV_SLOT_MGR_MOVE_ITEM, INV_SLOT_MGR_SELECT_SLOT, ISSUE_PET_COMMAND,
            MEMCHECK4_PROCESS_ENUM, NET_SEND, OUTBOUND_MSG_COUNTER, PINST_ACTIVE_CORPSE,
            PINST_CCHAT_WINDOW_MANAGER, PINST_CDISPLAY, PINST_CEVERQUEST, PINST_CINV_SLOT_MGR,
            PINST_CONTEXT_MENU_MANAGER, PINST_CONTROLLED_PLAYER, PINST_CXWND_MANAGER,
            PINST_LOCAL_PC, PINST_LOCAL_PLAYER, PINST_SGRAPHICSENGINE, PINST_SPAWN_MANAGER,
            PINST_SPELL_MANAGER, PINST_TARGET, PROCESS_GAME_EVENTS, REAL_RENDER_WORLD,
            RIGHT_CLICKED_ON_PLAYER, SERVER_MEMCHECK_HANDLER, SPELL_BOOK_WND_MEMORIZE_SET,
            SYSTEM_FINGERPRINT, USE_SKILL, WORLD_AUTHENTICATE, ZONE_GUIDE_MANAGER,
            context_menu_mgr, player_base, player_zone, spawn_manager, zone_info,
        };
        ...
        globals.insert(
            "instEQZoneInfo".to_string(),
            zone_info::INST_EQ_ZONE_INFO,
        );
