...
Current workspace totals: 368,483 Rust lines, ~7,627 tests, and 15 workspace crates. Latest release: v0.7.0-alpha. This page and the README badges are auto-refreshed by `scripts/update_readme_metrics.py`.
