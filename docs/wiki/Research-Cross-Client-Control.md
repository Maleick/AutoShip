...
- [docs/wiki/Research-MacroQuest-Ecosystem.md](Research-MacroQuest-Ecosystem.md)
...
All items in this document are **Research-backed** (see `Research-JMB-Relay-Comparison.md` and `Research-MacroQuest-Ecosystem.md`). No items are marked Live-validated until a live EQ client integration test is run.
...
| KissAssist TUI translation                     | Done   | `Research-MacroQuest-Ecosystem.md`                      |
