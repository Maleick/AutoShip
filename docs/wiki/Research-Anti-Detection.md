...
- [ETW LoadLibrary Instrumentation](../etw-ti-loadlibrary.md) — Windows event tracing for DLL loading detection
- [ETW SetThreadContext Instrumentation](../etw-ti-setthreadcontext.md) — Windows event tracing for thread context injection
- [ETW VirtualProtect Instrumentation](../etw-ti-virtualprotect.md) — Windows event tracing for memory protection changes
- [Hook Detection Surface Research](hook-detection-surface.md) — Detecting detour hooks and other in-process modifications
