...
- `.github/workflows/copilot-ci-dispatch.yml` sweeps open same-repo Copilot PRs from `master` and dispatches `CI` when the PR-triggered run is stuck in approval
