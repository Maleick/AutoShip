...
MQ2: `mq2-reference/src/plugins/autologin/`
...
MQ2: `mq2-reference/src/eqlib/include/eqlib/game/CXWnd.h`, UI headers
...
MQ2: `mq2-reference/src/routing/` (PostOffice, NamedPipes, Network)
...
MQ2: `mq2-reference/src/eqlib/include/eqlib/offsets/eqgame.h`
...
| Version tracking | __ClientDate + __ExpectedVersionDate | CLIENT_DATE constant | ✅ | Both track target client version |
